...
using MultiTenancy.Infrastructure.Strategies;
using MultiTenancy.Infrastructure.Stores;
    ...
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "MultiTenancy.Api v1"));
            }
